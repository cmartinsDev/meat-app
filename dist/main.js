        ...
        if (errorResponse instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
            ...
            this.zone.run(function () {
                switch (errorResponse.status) {
                    case 0:
                        _this.notificationService.notify(message_1 || 'Oh No! Parece que a nossa base de dados esta fora. Por favor tente mais tarde.');
                        break;
                    case 401:
...
/* harmony import */ var _order_summary_order_summary_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./order-summary/order-summary.component */ "./src/app/order-summary/order-summary.component.ts");
...
// # 
 // Angular 6, It was necessary to add registerLocaleData

Object(_angular_common__WEBPACK_IMPORTED_MODULE_19__["registerLocaleData"])(_angular_common_locales_pt__WEBPACK_IMPORTED_MODULE_20___default.a, 'pt');
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _order_summary_order_summary_component__WEBPACK_IMPORTED_MODULE_16__["OrderSummaryComponent"],
            ...
            providers: [{ provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["LOCALE_ID"], useValue: 'pt' },
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ErrorHandler"], useClass: _app_error_handler__WEBPACK_IMPORTED_MODULE_23__["ApplicationErrorHandler"] }],
...
var ROUTES = [
    ...
    { path: 'order', loadChildren: './order/order.module#OrderModule', canLoad: [_security_loggedin_guard__WEBPACK_IMPORTED_MODULE_8__["LoggedInGuard"]], canActivate: [_security_loggedin_guard__WEBPACK_IMPORTED_MODULE_8__["LoggedInGuard"]] },
...
var NotFoundComponent = /** @class */ (function () {
    ...
    NotFoundComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('notFoundAppeared', [
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('void => ready', [
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 0, transform: 'translateY(-50px)' }),
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.checkOrder = function (order) {
        return this.http.post(app_app_api__WEBPACK_IMPORTED_MODULE_4__["MEAT_API"] + "/orders", order).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (order) { return order.id; }));
    };
    OrderService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [app_restaurant_detail_shopping_cart_shopping_cart_service__WEBPACK_IMPORTED_MODULE_1__["ShoppingCartService"],
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('menuItemAppeared', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('ready', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 1 })),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["transition"])('void => ready', [
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 0, transform: 'translateY(-60px)' }),
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["animate"])('300ms 0s ease-in')
                    ])
                ])
            ]
...
module.exports = "<!--INÍCIO DO MENU -->\n<div class=\"col-md-9 col-xs-12\">\n  <mt-menu-item *ngFor=\"let item of menu | async\" [menuItem]=\"item\" (add)=\"shopingCart.addItem($event)\"></mt-menu-item>  \n</div>\n<div class=\"col-md-3 col-xs-12\">\n  <mt-shopping-cart #shopingCart></mt-shopping-cart>\n</div>\n <!-- FIM DO MENU -->  "
...
var MenuComponent = /** @class */ (function () {
    ...
    MenuComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_restaurants_restaurants_service__WEBPACK_IMPORTED_MODULE_1__["RestaurantsService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], MenuComponent);
...
/* harmony import */ var _restaurants_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./restaurants.service */ "./src/app/restaurants/restaurants.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RestaurantsComponent = /** @class */ (function () {
    ...
    RestaurantsComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Search-bar
        this.seachControl = this.fb.control('');
        this.searchForm = this.fb.group({
            searchControl: this.seachControl
        });
        this.seachControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (searchTerm) { return _this.restaurantsService.restaurants(searchTerm)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])([]); })); })).subscribe(function (restaurants) { return _this.restaurants = restaurants; });
    ...
    RestaurantsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('toggleSearch', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('hidden', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 0, "max-height": "0px" })),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('visible', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 1, "max-height": "70px", "margin-top": "20px" })),
        ...
        __metadata("design:paramtypes", [_restaurants_service__WEBPACK_IMPORTED_MODULE_5__["RestaurantsService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
...
var LoginService = /** @class */ (function () {
    function LoginService(http, router) {
        ...
        this.http = http;
        this.router = router;
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (e) { return e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]; })).subscribe(function (e) { return _this.lastUrl = e.url; });
    }
    ...
    LoginService.prototype.login = function (email, password) {
        var _this = this;
        return this.http.post(_app_api__WEBPACK_IMPORTED_MODULE_2__["MEAT_API"] + "/login", { email: email, password: password }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (user) { return _this.user = user; }));
    };
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])("snack-visibility", [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('hidden', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 0, bottom: '0px' })),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["state"])('visible', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["style"])({ opacity: 1, bottom: '30px' })),
...
/* harmony import */ var _security_login_login_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./../security/login/login.service */ "./src/app/security/login/login.service.ts");
/* harmony import */ var _security_loggedin_guard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../security/loggedin.guard */ "./src/app/security/loggedin.guard.ts");
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule.forRoot = function () {
        return {
            ...
            providers: [app_restaurant_detail_shopping_cart_shopping_cart_service__WEBPACK_IMPORTED_MODULE_6__["ShoppingCartService"],
                ...
                _security_login_login_service__WEBPACK_IMPORTED_MODULE_11__["LoginService"],
                _security_loggedin_guard__WEBPACK_IMPORTED_MODULE_12__["LoggedInGuard"],
    ...
    SharedModule = SharedModule_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_input_input_component__WEBPACK_IMPORTED_MODULE_1__["InputComponent"], _radio_radio_component__WEBPACK_IMPORTED_MODULE_2__["RadioComponent"], _rating_rating_component__WEBPACK_IMPORTED_MODULE_3__["RatingComponent"], _messages_snackbar_snackbar_component__WEBPACK_IMPORTED_MODULE_9__["SnackbarComponent"]],
            imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]],
            exports: [_input_input_component__WEBPACK_IMPORTED_MODULE_1__["InputComponent"], _radio_radio_component__WEBPACK_IMPORTED_MODULE_2__["RadioComponent"], _messages_snackbar_snackbar_component__WEBPACK_IMPORTED_MODULE_9__["SnackbarComponent"], _rating_rating_component__WEBPACK_IMPORTED_MODULE_3__["RatingComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["CommonModule"]]
        })
    ], SharedModule);
    return SharedModule;
    var SharedModule_1;
...
module.exports = __webpack_require__(/*! /home/carlos_martins/projects/udemy-angular/meat-app-starter/src/main.ts */"./src/main.ts");
